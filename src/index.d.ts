...
type ScaleMethodsMixins<TranslateArgs extends any[]> = {
  ...
  scale<InvalidScaleArgs extends any[]>(params: (...args: InvalidScaleArgs) => number): InvalidTile<InvalidScaleArgs, TranslateArgs>;
}
...
type TranslateMethodsMixins<ScaleArgs extends any[]> = {
  ...
  translate<InvalidTranslateArgs extends any[]>(params: (...args: InvalidTranslateArgs) => [number, number]): InvalidTile<ScaleArgs, InvalidTranslateArgs>;
}

type InvalidTile<ScaleArgs extends any[], TranslateArgs extends any[]> = BaseTile<ScaleArgs, TranslateArgs> & ScaleMethodsMixins<TranslateArgs> & TranslateMethodsMixins<ScaleArgs>;

type ConstantScaleTile<TranslateArgs extends any[]> = BaseTile<[], TranslateArgs> & ScaleMethodsMixins<TranslateArgs> & {
  translate(params: () => [number, number]): Tile<[]>;
  translate(params: null | [number, number]): Tile<[]>;
  translate<InvalidTranslateArgs extends any[]>(params: (...args: InvalidTranslateArgs) => [number, number]): ConstantScaleTile<InvalidTranslateArgs>;
}

type ConstantTranslateTile<ScaleArgs extends any[]> = BaseTile<ScaleArgs, []> & TranslateMethodsMixins<ScaleArgs> & {
  scale(params: () => number): Tile<[]>;
  scale(params: null | number): Tile<[]>;
  scale<InvalidScaleArgs extends any[]>(params: (...args: InvalidScaleArgs) => number): ConstantTranslateTile<InvalidScaleArgs>;
};
